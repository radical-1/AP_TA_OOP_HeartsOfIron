...
public enum Tile {
    ...
    static {
        ...
        TILE16.landNeighbors.addAll(Arrays.asList(TILE12, TILE15, TILE39));
        TILE17.landNeighbors.addAll(Arrays.asList(TILE18, TILE23));
        TILE18.landNeighbors.addAll(Arrays.asList(TILE17, TILE19, TILE24));
        TILE19.landNeighbors.addAll(Arrays.asList(TILE18, TILE20, TILE25));
        TILE20.landNeighbors.addAll(Arrays.asList(TILE19, TILE21, TILE26));
        TILE21.landNeighbors.addAll(Arrays.asList(TILE20, TILE22, TILE27));
        TILE22.landNeighbors.addAll(Arrays.asList(TILE21, TILE28));
        ...
        TILE28.landNeighbors.addAll(Arrays.asList(TILE22, TILE27, TILE34));
        ...
        TILE35.landNeighbors.addAll(Arrays.asList(TILE36, TILE39));
        TILE36.landNeighbors.addAll(Arrays.asList(TILE35, TILE37, TILE40));
        TILE37.landNeighbors.addAll(Arrays.asList(TILE36, TILE38, TILE41));
        TILE38.landNeighbors.addAll(Arrays.asList(TILE37, TILE42));
        ...
        TILE43.landNeighbors.addAll(Arrays.asList(TILE39, TILE44, TILE47));
        ...
        TILE47.landNeighbors.addAll(Arrays.asList(TILE43, TILE48));
        ...
        TILE50.landNeighbors.addAll(Arrays.asList(TILE46, TILE49));
        TILE51.landNeighbors.addAll(Arrays.asList(TILE52, TILE53));
        TILE52.landNeighbors.addAll(Arrays.asList(TILE51, TILE53));
        TILE53.landNeighbors.addAll(Arrays.asList(TILE51, TILE52));
        TILE54.landNeighbors.addAll(Arrays.asList(TILE55, TILE56));
        TILE55.landNeighbors.addAll(Arrays.asList(TILE54, TILE56));
        TILE56.landNeighbors.addAll(Arrays.asList(TILE54, TILE55));
    }
